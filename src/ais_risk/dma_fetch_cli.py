...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Download DMA historical AIS zip archives by date range (with optional extraction). "
    ...
    parser.add_argument("--base-url", default="https://web.ais.dk/aisdata", help="Base URL for daily zip files.")
    parser.add_argument(
        "--fallback-base-urls",
        help="Optional comma-separated fallback base URLs tried when primary base-url fails.",
    )
    parser.add_argument("--filename-template", default="aisdk-{date}.zip", help="Filename template, supports {date}.")
