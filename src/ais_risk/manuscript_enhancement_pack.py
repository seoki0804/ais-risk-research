    ...
    *,
    ...
    prior_work_rows = [
        ...
        },
        {
            ...
            "gap_to_close": "None (deterministic near-miss proxy label rule integrated in Methods 2.4).",
        },
        {
            "id": "RW-04",
        ...
        },
        {
            ...
            "current_coverage": "high",
            "gap_to_close": "None (compact related-work differential table integrated in manuscript Section 12.1).",
        },
        {
            "id": "RW-10",
    ...
    related_work_differential_rows = [
        {
            "rw_id": "RW-03",
            "prior_focus": "AIS near-miss detection proxy from realized trajectory proximity.",
            "prior_gap": "Limited linkage to calibration-governed operational thresholding.",
            "this_study_delta": "Combines near-miss proxy labeling with ECE-gated model/threshold governance.",
        },
        {
            "rw_id": "RW-04",
            "prior_focus": "Real-time multi-vessel collision-risk surveillance architecture.",
            "prior_gap": "Less emphasis on cross-region transfer uncertainty and significance control.",
            "this_study_delta": "Adds cross-region transfer CI + repeated-randomization significance appendices.",
        },
        {
            "rw_id": "RW-05",
            "prior_focus": "Velocity-obstacle geometry baseline for risk candidate detection.",
            "prior_gap": "Geometry-first approach lacks ML calibration comparison protocol.",
            "this_study_delta": "Presents tabular/raster ML ablation with calibration constraints and utility analysis.",
        },
        {
            "rw_id": "RW-07",
            "prior_focus": "AIS feature pipeline with ML-based risk prediction feasibility.",
            "prior_gap": "Weak emphasis on reviewer-ready uncertainty artifact packaging.",
            "this_study_delta": "Provides manuscript-grade uncertainty/significance/consistency artifact bundle.",
        },
        {
            "rw_id": "RW-08",
            "prior_focus": "Regional quantitative AIS risk diagnostics.",
            "prior_gap": "Transfer-route directionality and route-specific statistical robustness underreported.",
            "this_study_delta": "Reports route-level delta direction probability and Holm-adjusted repeated tests.",
        },
        {
            "rw_id": "RW-09",
            "prior_focus": "Method taxonomy and limitation overview for maritime collision risk.",
            "prior_gap": "Taxonomy not tied to concrete acceptance-gated manuscript workflow.",
            "this_study_delta": "Converts taxonomy into examiner-acceptance TODO closure matrix.",
        },
        {
            "rw_id": "RW-11",
            "prior_focus": "Calibration necessity for modern predictive models.",
            "prior_gap": "No maritime-specific ECE governance instantiation.",
            "this_study_delta": "Operationalizes ECE<=0.1 gate for model and threshold decision flow.",
        },
        {
            "rw_id": "RW-12",
            "prior_focus": "Theoretical source-target divergence bound for transfer learning.",
            "prior_gap": "Theory-to-route evidence bridge is often qualitative only.",
            "this_study_delta": "Connects divergence caution to route-level empirical transfer significance outcomes.",
        },
    ]
    related_work_differential_md_table = _markdown_table(
        related_work_differential_rows,
    ...
    ko_text = "\n".join(
        [
            ...
            *ablation_ko_lines,
            ...
            related_work_differential_md_table,
            "",
            "## 13. 심사관 관점 우선 TODO",
        ...
        "\n".join(
            [
                ...
                *significance_en_lines,
                ...
                f"- Route-level repeated-randomization companion is reported in `{transfer_repeated_randomization_appendix_path.name}`.",
                "",
            ]
        ),
        encoding="utf-8",
    ...
    manuscript_todo_path.write_text(
        "\n".join(
            [
                ...
                f"- [x] Close examiner-critical gaps with acceptance criteria (`{examiner_review_todo_path.name}`).",
