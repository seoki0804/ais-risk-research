...
usage() {
  cat <<'EOF'
Usage:
  run_true_new_area_la_long_beach_candidate_scan_61day.sh [DATE] [RUN_DATE]

Description:
  Run reviewer-safe LA/Long Beach candidate scan for a single NOAA date,
