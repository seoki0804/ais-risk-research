...
Usage:
  MAX_ROW_GROUPS=2 LIMIT_ROWS=12000 \
    run_cross_year_2024_seattle_candidate_scan_61day.sh [DATE] [RUN_DATE]

Description:
  Convert remote 2024 MarineCadastre daily parquet for the Seattle harbor
