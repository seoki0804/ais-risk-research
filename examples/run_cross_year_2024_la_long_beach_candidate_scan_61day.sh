...
DATE="${1:-2024-09-05}"
RUN_DATE="${2:-2026-03-17_r40}"
AREA="la_long_beach_2024"
DATE_TAG="${DATE//-/}"
...
Usage:
  MAX_ROW_GROUPS=1 LIMIT_ROWS=5000 \
    run_cross_year_2024_la_long_beach_candidate_scan_61day.sh [DATE] [RUN_DATE]

Description:
  Convert remote 2024 MarineCadastre daily parquet for the LA/Long Beach harbor
  window into NOAA-style raw CSV, then run the light-weight chain
