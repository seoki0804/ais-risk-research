...
DEST_DIR="${DEST_DIR:-${ROOT}/docs/results/2026-04-04}"

MULTI_DIR="${ROOT}/outputs/2026-04-04_all_models_multiarea_support_adjusted"
SWEEP_DIR="${ROOT}/outputs/2026-04-04_all_models_seed_sweep_support_adjusted"
...
MANIFEST_PATH="${DEST_DIR}/bundle_manifest_2026-04-04.txt"
{
  echo "bundle_date=2026-04-04"
