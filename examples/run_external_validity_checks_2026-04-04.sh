...
COMMAND_LOG_PATH="${COMMAND_LOG_PATH:-${ROOT}/outputs/2026-04-04_external_validity_command_log.txt}"
...
TAXONOMY_OUTPUT_ROOT="${TAXONOMY_OUTPUT_ROOT:-${ROOT}/outputs/2026-04-04_error_taxonomy}"
...
(
  ...
  run_logged \
    "export_github_results_bundle_2026-04-04_expanded.sh" \
